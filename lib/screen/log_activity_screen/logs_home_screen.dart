...
import 'package:flutter_presensi/model/log_activity.dart';
import 'package:flutter_presensi/screen/log_activity_screen/add_log_screen.dart';
import 'package:flutter_presensi/screen/log_activity_screen/update_log_screen.dart';

class LogsActivityScreen extends StatefulWidget {
  final String nik; // Assume you pass nik from previous screen
  final String token; // JWT token

  const LogsActivityScreen({super.key, required this.nik, required this.token});
